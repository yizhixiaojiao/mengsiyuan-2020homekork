...
import com.example.myfinalapplication.bean.UserInfo;
import com.example.myfinalapplication.database.UserDBHelper;
import com.example.myfinalapplication.util.DateUtil;
import com.example.myfinalapplication.util.ViewUtil;
...
public class LoadActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","189900104 孟思远"};
